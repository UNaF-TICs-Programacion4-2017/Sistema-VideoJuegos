				...
				<div class="container">
					<div class="page">
						...
						<table class="cart">
							<thead>
								<tr>
									<th class="tipo-producto">Tipo Producto</th>
									<th class="nombre-producto">Nombre</th>
									<th class="descripcion-producto">Descripcion</th>
									<th class="precio-producto">Precio</th>
									<th class="canidad-producto">Cantidad</th>
									<th class="linkyoutube-producto">Link YouTube</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="tipo-producto">
										<select name="#">
											...
											<option value="5">Figura de Accion</option>
										</select>
									</td>
									...
									<td class="linkyoutube-producto">
										<input type="text" placeholder="Ingresar URL YouTube">
									</td>
									<td>
										<a href="#" class="button">Insertar</a>
									</td>		
								</tr>
